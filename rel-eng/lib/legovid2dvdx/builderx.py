...
""" Code for building legovid2dvd docs and committing them. """
...
class CustomBuilder(builder.Builder):
    ...
    def _rpm(self):
        ...
        git_commit = common.run_command("git commit --allow-empty -m \"Updated README markdown file and build artifacts.\" README.md")
